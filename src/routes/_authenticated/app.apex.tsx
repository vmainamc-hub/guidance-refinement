            ...
            {best ? (
              <>
                ...
                <Accordion type="multiple" className="space-y-3">
                  <AccordionItem value="verdict" className="glass rounded-xl border border-border/50 px-4">
                  ...
                  <AccordionItem value="psychology" className="glass rounded-xl border border-border/50 px-4">
                    <AccordionTrigger className="font-mono text-[11px] uppercase tracking-[0.22em]">
                  ...
                  <AccordionItem value="quality" className="glass rounded-xl border border-border/50 px-4">
                    <AccordionTrigger className="font-mono text-[11px] uppercase tracking-[0.22em]">
                      Quality metrics
                    </AccordionTrigger>
                  ...
                  <AccordionItem value="forward" className="glass rounded-xl border border-border/50 px-4">
                    <AccordionTrigger className="font-mono text-[11px] uppercase tracking-[0.22em]">
                  ...
                  <AccordionItem value="simdetail" className="glass rounded-xl border border-border/50 px-4">
                    <AccordionTrigger className="font-mono text-[11px] uppercase tracking-[0.22em]">
                      Simulator detail
                    </AccordionTrigger>
                    <AccordionContent className="pb-4">
                  ...
                  <AccordionItem value="runnerup" className="glass rounded-xl border border-border/50 px-4">
                    <AccordionTrigger className="font-mono text-[11px] uppercase tracking-[0.22em]">
...
function BestOpportunity({
  ...
  const survivalColor = !surv || !surv.sufficient
    ? "var(--warn)"
    : surv.label === "STRONG"
      ? "var(--bull)"
      : surv.label === "MODERATE"
