...
export function CanonicalAlertBanner({
  ...
  const expired = episodeMatches && (isExpired(alerts.episode) || alerts.episode!.status !== "ACTIVE");
    ...
    return (
      ...
      >
        ...
        <p className="mt-1 text-[11px] text-muted-foreground">
          The previously alerted candidate is no longer actionable. The card below shows the
          current best opportunity, which has not triggered an alert.
        </p>
      </div>
    );
  }
