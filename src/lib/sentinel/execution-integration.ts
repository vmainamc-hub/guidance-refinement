 ...
 */
export function survivalInfluence(
  ...
  const stabilityPart = report.postEntryStability >= 60 ? 0.5 : report.postEntryStability < 35 ? -1 : 0;
  ...
  return {
    ...
    detail:
      ...
      (report.deteriorationPoint ? `, deterioration from run ${report.deteriorationPoint}` : ", no deterioration point inside the window") +
